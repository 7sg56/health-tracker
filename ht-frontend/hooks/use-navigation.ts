...
export function useNavigation(
  ...
  return {
    ...
    getItemByHref: (href: string) => navigationItems.find(item => item.href === href),
  };
}
...
export function useNavigationAnalytics() {
  const trackNavigation = useCallback((item: NavigationItem, source: 'sidebar' | 'breadcrumb' | 'shortcut' = 'sidebar') => {
...
export function useNavigationPreferences() {
  ...
  return {
    preferences,
    updatePreferences,
    toggleSidebar: () => updatePreferences({ sidebarCollapsed: !preferences.sidebarCollapsed }),
    toggleBadges: () => updatePreferences({ showBadges: !preferences.showBadges }),
