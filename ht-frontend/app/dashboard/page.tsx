...
import { PageTransition, FadeIn, SlideIn, StaggeredChildren } from '@/components/ui/page-transition';
import { createInteractiveElement, microInteractions } from '@/lib/utils/animations';
...
export default function DashboardPage() {
  ...
  const totalExercise = todayWorkouts.reduce((sum, w) => sum + w.durationMin, 0);
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="text-center p-3 bg-background/50 rounded-lg border">
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <Card className="w-full max-w-md border-destructive/50 bg-destructive/5">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-destructive text-xl">Error Loading Dashboard</CardTitle>
  ...
  return (
    <PageTransition variant="fade" className="space-y-6">
      ...
      <SlideIn direction="up" delay={200}>
        <Card className={cn(
          "bg-gradient-to-r from-primary/5 via-primary/5 to-secondary/5 border-primary/20",
        ...
        <SlideIn direction="up" delay={300}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm text-muted-foreground">
              ...
              <span>{Math.max(0, waterGoal - totalWater).toFixed(1)}L remaining</span>
            </div>
          </CardContent>
          </Card>
        </SlideIn>
        ...
        <SlideIn direction="up" delay={400}>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-end justify-between">
              ...
              <Badge variant={calorieProgress >= 80 && calorieProgress <= 120 ? "default" : "secondary"}>
            ...
            <div className="flex items-center justify-between text-sm text-muted-foreground">
              ...
              <span>{Math.max(0, calorieGoal - totalCalories)} cal remaining</span>
            </div>
          </CardContent>
          </Card>
        </SlideIn>
        ...
        <SlideIn direction="up" delay={500}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm text-muted-foreground">
              ...
              <span>{Math.max(0, exerciseGoal - totalExercise)}min remaining</span>
            </div>
          </CardContent>
          </Card>
        </SlideIn>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge variant={waterProgress >= 100 ? "default" : "outline"}>
                  {waterProgress >= 100 ? '✓ Complete' : `${waterProgress.toFixed(0)}%`}
                </Badge>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                ...
                <Badge variant={calorieProgress >= 80 && calorieProgress <= 120 ? "default" : "outline"}>
                  {calorieProgress >= 80 && calorieProgress <= 120 ? '✓ Complete' : `${calorieProgress.toFixed(0)}%`}
                </Badge>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                ...
                <Badge variant={exerciseProgress >= 100 ? "default" : "outline"}>
                  {exerciseProgress >= 100 ? '✓ Complete' : `${exerciseProgress.toFixed(0)}%`}
                </Badge>
              </div>
            </div>
            ...
            <div className="pt-3 border-t">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm text-muted-foreground">
                  {Math.round((waterProgress + Math.min(calorieProgress, 100) + exerciseProgress) / 3)}%
                </span>
              </div>
              <Progress 
                value={(waterProgress + Math.min(calorieProgress, 100) + exerciseProgress) / 3} 
                className="h-2" 
              />
            </div>
          </CardContent>
