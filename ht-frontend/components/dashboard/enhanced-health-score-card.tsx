...
export function EnhancedHealthScoreCard({
  ...
  const getComponentStyle = (componentScore: number) => {
    if (componentScore >= 80) return { color: "text-green-600", bgColor: "bg-green-100 dark:bg-green-900/20", icon: "✅" };
    if (componentScore >= 60) return { color: "text-amber-600", bgColor: "bg-amber-100 dark:bg-amber-900/20", icon: "⚠️" };
    return { color: "text-red-600", bgColor: "bg-red-100 dark:bg-red-900/20", icon: "❌" };
  };
